...
class AuthenticationDialogWin(context: Context, private val listener: AuthenticationListenerWin) : Dialog(context) {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        this.setContentView(R.layout.auth_dialog_win)
    ...
    private fun initializeWebView(url: String) {
        val webView = findViewById<WebView>(R.id.web_view_win)
