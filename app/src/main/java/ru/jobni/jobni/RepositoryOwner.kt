...
object RepositoryOwner {
    ...
    private fun makeParentOneOwner(): NavigationParent {
        return NavigationParent("Добавить компанию", makeParentOneChildOwner(), R.drawable.ic_company)
    }
    ...
    private fun makeParentTwoOwner(): NavigationParent {
        return NavigationParent("Компания 1", makeParentTwoChildOwner(), R.drawable.ic_user)
    }
